...
class TransaksiProduk extends CI_Controller
{
    ...
    public function index()
    {
        $data = [
            'notif' => '',
            'title' => 'Transaksi Produk - Master Admin',
            'active' => 'TransaksiProduk',
            'breadcumbs' => [
                'Transaksi Produk' => ['title' => 'Transaksi Produk', 'link' => 'admin-master/TransaksiProduk'],
            ],
            'data' => $this->Setting_website_model->getDataWebsite(),
            'icon' => $this->Setting_website_model->getDataSosmed()->result_array(),
        ];
        $this->template2->views('admin/master-admin/TransaksiProduk/index', $data);
    }
}
