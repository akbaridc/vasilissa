<section class="section">
    <div class="section-header">
        <h1>Transaksi Withdraw Cash</h1>
        <?= $breadcumbnya; ?>
    </div>
    <div class="section-body">
        <h2 class="section-title">Transaksi Withdraw Cash</h2>
                            ...
                            <table class="table table-bordered table-striped" id="test">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Akbar Imawan Dwi Cahya
                                            <div class="table-links">
                                                <a data-toggle="modal" data-target="#viewTCash" href="#">Lihat</a>
                                            </div>
                                        </td>
                                        <td>1</td>
