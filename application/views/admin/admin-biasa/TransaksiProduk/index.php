            ...
            <div class="col-12 col-lg-12 col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="mr-auto">
                            <a href="<?= base_url('admin/TransaksiProduk/tambah') ?>" class="btn btn-primary"> <i class="fas fa-plus"></i> Tambah Data</a>
                        </div>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>Akbar Imawan Dwi Cahya
                                            <div class=" table-links">
                                                ...
                                                <a class="badge badge-warning text-white" href="<?= base_url('admin/TransaksiProduk/edit') ?>">Edit</a>
                                            </div>
                                        </td>
                                        <td>BRG001</td>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-icon btn-success approve"><i class="fas fa-check"> Approve</i></button>
                                            <button class="btn btn-icon btn-danger tolak"><i class="fa fa-times"> Tolak</i></button>
                                        </td>
                                    </tr>
...
<script>
    ...
    $('.approve').on('click', function() {
        Swal.fire({
            ...
            text: "anda akan mengapprove transaksi ini",
            icon: 'warning',
    ...
    $('.tolak').on('click', function() {
        Swal.fire({
            title: "Kenapa?",
            text: "alasan kenapa transaksi produk ditolak:",
            input: 'text',
            showCancelButton: true
        }).then((result) => {
            if (result.value) {
