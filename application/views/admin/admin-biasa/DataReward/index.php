                                        ...
                                        <tr>
                                            ...
                                            <td><?= $values->level ?>
                                                <div class="table-links">
                                                    ...
                                                    <a class="badge badge-warning text-white" href="<?= base_url('admin/DataReward/edit/' . $values->id) ?>">Edit</a>
                                                    <div class="bullet"></div>
                                                    <a href="<?= base_url('admin/hapus_reward/' . $values->id) ?>" class="badge badge-danger text-white delete">Hapus</a>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <?php if ($values->status == 1) { ?>
                                                    <a href="<?= base_url('admin/nonaktif_reward/' . $values->id) ?>" class="btn btn-sm btn-success status">Aktif</a>
                                                <?php } else { ?>
