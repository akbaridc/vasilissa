<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">Data Produk Item </h2>
        <p class="section-lead">
            Berikut ini adalah data produk item
        </p>
            ...
            <div class="col-12 col-lg-12 col-md-12">
                <div class="card card-primary">
                    <div class="card-body">
                        ...
                        <a href="<?= base_url('member/produk-item/beli') ?>">
                            <button class="btn btn-primary btn-md"><b> + Beli Produk Item</b></button>
                        </a>
                        <br>
                        <br>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $value->kode_produk ?>
                                                <div class=" table-links">
                                                    <a class="badge badge-info text-white itemModalDetail" style="cursor: pointer;" data-id="<?= $value->id ?>">Lihat</a>
                                                    <?php if ($value->status == 0 || $value->status == 1) { ?>
                                                        <div class="bullet"></div>
                                                        <a class="badge badge-warning text-white" href="<?= base_url('member/DataProduk/item_edit/' . $value->id) ?>">Edit</a>
                                                        <div class="bullet"></div>
                                                        <a class="badge badge-danger text-white delete" href="<?= base_url('member/hapus_produk_item/' . $value->id) ?>">Hapus</a>
                                                    <?php } ?>

                                                </div>

                                            </td>
                                            <td><?= $value->qty ?> Item</td>
                                            ...
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    <button data-toggle="modal" data-target="#buktiPembayaranItem" data-kode_produk="<?= $value->kode_produk ?>" data-nama_produk="<?= $value->nama_produk ?>" data-qty="<?= $value->qty ?>" data-harga="<?= $value->harga ?>" data-id="<?= $value->id; ?>" class="btn btn-icon btn-warning"><i class="fas fa-images"> Bukti Pembayaran</i></button>
                                                <?php } ?>
                                            </td>
                                            <td>
...
<!-- modal view -->
<div class="modal fade" tabindex="-1" role="dialog" id="itemModalDetail">
...
<div class="modal fade" tabindex="-1" role="dialog" id="buktiPembayaranItem">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(base_url() . 'member/uploadPembayaran_item', array('method' => 'post')); ?>
            <div class="modal-body">
                <table class="table table-striped">
                    <tr>
